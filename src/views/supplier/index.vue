        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="联系方式">
              <el-input v-model="formData.supplierPhone" placeholder="联系方式"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="公司邮箱">
            <el-input v-model="formData.supplierEmail" placeholder="公司邮箱"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-form-item label="地址">
            <el-input v-model="formData.supplierAddress" placeholder="地址"></el-input>
          </el-form-item>
        </el-row>
       <el-row>
         <el-col :span="8">
           <el-form-item label="开户行">
             <el-input v-model="formData.supplierBank" placeholder="开户行"></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="16">
           <el-form-item label="银行卡号">
             <el-input v-model="formData.supplierBankCode" placeholder="银行卡号"></el-input>
           </el-form-item>
         </el-col>
       </el-row>
      </el-form>
